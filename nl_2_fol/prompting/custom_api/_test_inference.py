...
def test_all_custom_models():
    for model in ["t5-3b-nl-to-fol"]:
        ...
        failure_prompt_text = chebai_prompt._get_undef_failure_prompt(
            undefined_predicates
        )
        ...
        print(
            f"Undefined predicates failure prompt text: \n {failure_prompt_text} \n\n"
        )
