...
class ChemlogDefinition(FOLDefinition):
    def __init__(
        self,
        predicate_name: str,
...
class ChemlogModelChecker(AbstractModelCheckerWrapper):
    ...
    @parse_exception
    def parse_definition(self, formula: str) -> ChemlogDefinition:
    ...
    def does_mol_match_tptp_definition(
        ...
        temp_additional_defs: dict[str, ChemlogDefinition] | None = None,
    ) -> ModelCheckerOutcome:
